        ...
        <div className="relative rounded-2xl overflow-hidden w-full" style={{ minHeight: 420 }}>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-6 py-20" style={{ minHeight: 420 }}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://cal.com/respectfullydisruptive/30min" className="group bg-white/10 backdrop-blur-sm text-white text-lg font-medium rounded-lg px-8 py-3 w-full sm:w-auto flex items-center justify-center gap-3 hover:bg-white/20 transition-all duration-300 border border-white/30 mt-4">
                Book a call
                <svg 
